...
function addItems() {
  ...
  createItem(360, 500, 'poison');
  createItem(225, 500, 'coin');
  createItem(375, 400, 'coin');
  createItem(225, 300, 'coin');
  createItem(500, 300, 'coin');
  createItem(50, 200, 'coin');
  createItem(750, 175, 'poison');
  createItem(325, 125, 'coin');
  createItem(400, 125, 'poison');
  createItem(535,  50, 'star'); 
}
...
function addPlatforms() {
  ...
  platforms.create(5, 250, 'platform2');
  platforms.create(650, 225, 'platform');
  platforms.create(300 , 175, 'platform');
  platforms.create(450, 100, 'platform2');
...
window.onload = function () {
  ...
  function create() {
    ...
    livesText = game.add.text(16, 40, "LIVES: " + lives, { font: "bold 24px Arial", fill: "white" });
